...
ln -s "$(pwd)/node_modules/@xrkseek/cordis" "$WORK/node_modules/@xrkseek/cordis"
...
// The vendored-cordis path: `Context` from '@xrkseek/cordis' plus the
...
import type { Context as VendoredContext } from '@xrkseek/cordis'
