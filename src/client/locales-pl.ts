...
export const pl: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Przeglądaj więcej wtyczek na GitHub (topic: xrkh-better-sidebar)',
  ...
  pluginSuhuangScrollDesc: 'Łączy lokalny Suhuang Scroll Runtime z ustawieniami DSH i better-sidebar, zapewniając konfigurację modelu, test połączenia i sterowanie ciągłym ocenianiem; wymaga Suhuang Scroll Runtime i xrkh-better-sidebar',
