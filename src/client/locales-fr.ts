...
export const fr: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Parcourir plus de plugins sur GitHub (topic : xrkh-better-sidebar)',
  ...
  pluginSuhuangScrollDesc: 'Connecte le Runtime Suhuang Scroll local aux réglages DSH et à better-sidebar pour configurer le modèle, tester la connexion et contrôler la correction continue ; nécessite Suhuang Scroll Runtime et xrkh-better-sidebar',
