...
export const zhMO: Record<string, string> = {
  ...
  changesDiffOpenDesc: '「展開為獨立分頁」把 diff 放到哪裡',
  ...
  addPluginsBrowseMore: '在 GitHub 上瀏覽更多插件（topic: xrkh-better-sidebar）',
  ...
  pluginSuhuangScrollDesc: '把本機蘇黃共閱 Runtime 接入 DSH 設定與 better-sidebar，支援模型設定、連線測試及連續閱卷控制；使用前須安裝 Suhuang Scroll Runtime 與 xrkh-better-sidebar',
