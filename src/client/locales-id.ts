...
export const id: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Jelajahi lebih banyak plugin di GitHub (topic: xrkh-better-sidebar)',
  ...
  pluginSuhuangScrollDesc: 'Menghubungkan Suhuang Scroll Runtime lokal ke pengaturan DSH dan better-sidebar untuk konfigurasi model, uji koneksi, dan kontrol penilaian berkelanjutan; memerlukan Suhuang Scroll Runtime dan xrkh-better-sidebar',
