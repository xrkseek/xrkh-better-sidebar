...
export const ja: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'GitHub でプラグинをさらに閲覧（topic: xrkh-better-sidebar）',
  ...
  pluginSuhuangScrollDesc: 'ローカルの Suhuang Scroll Runtime を DSH 設定と better-sidebar に接続し、モデル設定、接続テスト、連続採点の操作を提供。Suhuang Scroll Runtime と xrkh-better-sidebar が必要',
