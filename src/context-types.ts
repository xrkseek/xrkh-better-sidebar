 ...
 *
 * The type base is the vendored `@xrkseek/cordis` Context (the runtime
 ...
 * packages already augment `@xrkseek/cordis`, and the host and client
 ...
 */
import type { Context as CordisContext } from '@xrkseek/cordis'
...
/**
 * The client locale service face (mirror of @xrkseek/client-locale's
...
/**
 * The invariant service face (mirror of @xrkseek/xrk-invariants'
 ...
 * that imports `Context` from `@xrkseek/cordis` and does
